...
internal data class ModelTaskOperationBackfill(
    val taskId: String,
...
internal fun SQLiteConnection.readLegacyModelTaskOperations(): List<ModelTaskOperationBackfill> =
    buildList {
        prepare(
            """
...
internal fun SQLiteConnection.insertModelTaskOperations(
...
internal fun SQLiteConnection.insertModelTaskOperationBackfill(
